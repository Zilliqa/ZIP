...
staking program, we believe that it will easier to capture long-term token
holders.  For instance, since staking program rewards more to long-term holders
with larger stake, tying gZIL issuance with staking can help identify such
token holders. We explain this more in the following section. 
