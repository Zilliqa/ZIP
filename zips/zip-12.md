...
2. The Snapshot vote requires > 30 $gZIL to initiate. It will be binding, and must be open for at least 5 days. At least 20% quorum must be reached, and more than 50% of those votes must vote “For” the proposal for it to pass.
